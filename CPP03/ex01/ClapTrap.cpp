...
ClapTrap::ClapTrap(std::string nameGiven) : _name(nameGiven), _hitPoints(100), _energyPoints(50), _attackDamages(20){
    std::cout << "ClapTrap Constructor called" << std::endl;
    return;
}
ClapTrap::ClapTrap() : _name("ClapTrap"), _hitPoints(100), _energyPoints(50), _attackDamages(20){
    std::cout << "ClapTrap Constructor called" << std::endl;
    return;
}
